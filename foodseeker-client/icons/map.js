...
const MixedMealPantryPath = ({ inactive, filter }) => (
  <g>
    <path
    ...
    <path
      ...
      fill={palette.secondary.contrast}
    />
    <path
...
const PantryPath = ({ inactive, filter = '' }) => (
  <g>
    <path
...
const MealPath = ({ inactive, filter = '' }) => (
  <g>
    <path
...
const MapIcon = ({ category, inactive, onClick, selected = false }) => {
  ...
  if (category === -1)
    content = <MixedMealPantryPath inactive={inactive} />
  else if (category === 0)
    content = <PantryPath inactive={inactive} filter={filter} />
  else if (category === 1)
    content = <MealPath inactive={inactive} filter={filter} />
